...
## Project Structure
    ...
    ├── testapiautodatamod_110339  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_110339`
...
2. Clone this repo and `cd testapiautodatamod_110339`
